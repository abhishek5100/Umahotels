  ...
  return (
    <div>
            <div className='bg-white'>
                ...
                <div className='bg-white border-t-2 md:grid md:grid-cols-4  md:gap-5 md:p-[100px] p-5' data-aos="fade-right">
                    {
                        Data && Data.map((value) => {
                            return (
                                
                                <div className="col-span-1 mt-5 rounded-xl h-fit shadow-inner "  >
...
export default Outsideguestmenu
